...
int[] GetPositiveNegativeElem(int[] arr)          // вариант с одим методом
{
    int sumPositive = 0;
    int sumNegative = 0;
    for (int i = 0; i < arr.Length; i++)
...
//вариант с двумя отдельными методами
...
int[] sumPositiveNegativeElem = GetPositiveNegativeElem(array);
